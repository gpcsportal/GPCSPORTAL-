...
(() => {
  ...
  const pages={
    ...
    gallery:()=>hero('College Life','Image Gallery','Browse approved college images or add a new image to the correct category.')+`<div class="route-content"><div class="route-actions" style="margin-top:0;margin-bottom:15px"><button class="route-btn primary" type="button" id="previewAddImage">＋ Add Image</button></div><input id="previewGalleryInput" type="file" accept="image/*" multiple hidden><div class="route-gallery" aria-label="Gallery upload categories"><button class="route-gallery-card" type="button" data-gallery-upload-category="Campus & Infrastructure"><b>Campus & Infrastructure</b><small>Add Image</small></button><button class="route-gallery-card" type="button" data-gallery-upload-category="College Events"><b>College Events</b><small>Add Image</small></button><button class="route-gallery-card" type="button" data-gallery-upload-category="Labs & Workshops"><b>Labs & Workshops</b><small>Add Image</small></button><button class="route-gallery-card" type="button" data-gallery-upload-category="Students & Staff"><b>Students & Staff</b><small>Add Image</small></button><button class="route-gallery-card" type="button" data-gallery-upload-category="Sports & Cultural"><b>Sports & Cultural</b><small>Add Image</small></button><button class="route-gallery-card" type="button" data-gallery-upload-category="Projects & Activities"><b>Projects & Activities</b><small>Add Image</small></button><button class="route-gallery-card" type="button" data-gallery-upload-category="Other College Related"><b>Other College Related</b><small>Add Image</small></button></div><div class="admin-section" style="margin-top:18px"><h3>Approved Gallery Images</h3><div id="previewGalleryLive" class="route-gallery" aria-live="polite"><div class="route-gallery-card"><b>Loading gallery…</b></div></div></div></div>`,
  ...
  function bindRoutePage(route){
    ...
    const galleryInput=routeShell.querySelector('#previewGalleryInput');
    routeShell.querySelector('#previewAddImage')?.addEventListener('click',()=>{
      if(!galleryInput) return;
      galleryInput.dataset.category='Other College Related';
      galleryInput.click();
    });
    routeShell.querySelectorAll('[data-gallery-upload-category]').forEach(button=>button.addEventListener('click',()=>{
      if(!galleryInput) return;
      galleryInput.dataset.category=button.dataset.galleryUploadCategory||'Other College Related';
      galleryInput.click();
    }));
